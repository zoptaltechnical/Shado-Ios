...
#define user_invite_code @"user_invite_code"
...
#define signInAccess_token @"signInAccess_token"


#define email12 @"email12"
#define UserLoginData @"UserLoginData"
...
#define myURL @"https://zoptal.com/demo/sendayo/cc_payment/delete_credit_card"
